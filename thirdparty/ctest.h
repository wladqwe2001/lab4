...
//7//#define CTEST_IMPL_DIAG_PUSH_IGNORED(w) \
//7//    CTEST_IMPL_PRAGMA(GCC diagnostic ignored "-W" #w)
...
//7//CTEST_IMPL_DIAG_PUSH_IGNORED(strict - prototypes)
...
void assert_equal_lf(double exp, double real, const char* caller, int line);
#define ASSERT_EQUAL_LF(exp, real) assert_equal_lf(exp, real, __FILE__, __LINE__)
